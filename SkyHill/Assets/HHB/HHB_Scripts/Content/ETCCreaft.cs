...
public class ETCCreaft : CreaftContent
{
    ...
    public override void CombinationImageMatch(int buttonIndex)
    {
        ...
        Dictionary<string, object> itemInfo = makingMaterial[buttonIndex];


        int com1 = NameToIDChanger.n2D.NameToID(makingMaterial[buttonIndex]["COM1"].ToString());
        int com2 = NameToIDChanger.n2D.NameToID(makingMaterial[buttonIndex]["COM2"].ToString());
        int com3 = NameToIDChanger.n2D.NameToID(makingMaterial[buttonIndex]["COM3"].ToString());
        int com4 = NameToIDChanger.n2D.NameToID(makingMaterial[buttonIndex]["COM4"].ToString());
        ...
        int makeId = NameToIDChanger.n2D.NameToID(itemInfo["MATERIAL_NAME"].ToString());
