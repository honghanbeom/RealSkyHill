...
public class FoodCreaft : CreaftContent
{
    ...
    {
        List<Dictionary<string, object>> foodMaking = CSVReader.Read("MAKINGFOOD");
        Dictionary<string, object> itemInfo = foodMaking[buttonIndex];



        //Debug.LogFormat(foodMaking[buttonIndex]["COM1"].ToString());
        //Debug.LogFormat(foodMaking[buttonIndex]["COM2"].ToString());
        //Debug.LogFormat(foodMaking[buttonIndex]["COM3"].ToString());
        //Debug.LogFormat(foodMaking[buttonIndex]["COM4"].ToString());



        int com1 = NameToIDChanger.n2D.NameToID(foodMaking[buttonIndex]["COM1"].ToString());
        int com2 = NameToIDChanger.n2D.NameToID(foodMaking[buttonIndex]["COM2"].ToString());
        int com3 = NameToIDChanger.n2D.NameToID(foodMaking[buttonIndex]["COM3"].ToString());
        int com4 = NameToIDChanger.n2D.NameToID(foodMaking[buttonIndex]["COM4"].ToString());
        ...
        int makeId = NameToIDChanger.n2D.NameToID(itemInfo["FOOD_NAME"].ToString());
